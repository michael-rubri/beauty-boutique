<template>
  <main class="makeup-page" role="main">
    <section class="makeup-hero" aria-label="Hero makeup">
      <img
          class="hero-bg"
          :src="heroImage"
          :alt="heroAlt"
      ...
      <div class="hero-overlay" role="region" aria-label="Titolo hero">
        <h1 class="hero-heading">Make-Up</h1>
        <p class="hero-sub">Valorizza la tua bellezza</p>
      </div>
    </section>

    <section class="makeup-intro" aria-label="Introduzione makeup">
      <div class="inner">
        <h1 class="section-service">Estetica di base</h1>
        <h2 class="section-title">Make-Up</h2>
        <p class="section-text">
          Valorizziamo la tua bellezza con servizi make-up professionali pensati per ogni occasione, stile ed esigenza. Ogni trucco viene realizzato su misura, nel rispetto delle tue caratteristiche e del risultato che desideri ottenere.<br><br>
          Offriamo make-up per:<br>
          •	Cerimonie e occasioni speciali<br>
          •	Sposa, con studio personalizzato e prove dedicate<br>
          •	Eventi serali e serate importanti<br>
          •	Trucco correttivo, per riequilibrare e valorizzare i lineamenti del viso<br><br>
          Inoltre proponiamo lezioni di self make-up personalizzate, durante le quali imparerai tecniche professionali e consigli pratici per valorizzarti al meglio nella vita di tutti i giorni. Scoprirai i prodotti più adatti a te, come applicarli correttamente e come esaltare la tua bellezza in modo semplice ed efficace.
          Affidati a mani esperte per sentirti sicura, luminosa e perfettamente in armonia con te stessa, in ogni occasione.
        </p>
      </div>
    </section>

    <section class="makeup-gallery" aria-label="Galleria">
      <div class="inner">
